...
const Footer = () => {
  return (
    <>
    <footer className="footer-1 bg-[#131313] text-white py-8 sm:py-12 lg:mb-0 mb-[7rem]">
  <div className="container mx-auto px-4">
    ...
    <div className="sm:flex sm:flex-wrap sm:-mx-4 mt-6 pt-6 sm:mt-12 sm:pt-12 border-t">
      <div className="px-4 sm:w-1/2 md:w-1/4 mt-4 md:mt-0">
        <h6 className="font-bold mb-2">хаяг</h6>
        <address className="not-italic mb-4 text-sm">
        Салбарын хаяг: Сүхбаатар дүүрэг, 5-р хороо, Нью Майнд Оффис, 1 давхар.
        </address>
      </div>
      <div className="px-4 sm:w-1/2 md:w-1/4 mt-4 md:mt-0">
        <h6 className="font-bold mb-2">Lynx</h6>
        <p className="mb-4 text-sm">© 2024. Бүх эрх хуулиар хамгаалагдсан <br/> Lynx ХХК</p>
      </div>
